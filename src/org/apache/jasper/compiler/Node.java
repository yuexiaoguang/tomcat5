...
abstract class Node implements TagConstants {
    ...
    protected Nodes namedAttributeNodes; // 缓存性能
    ...
    /**
     * 有关子元素的收集信息. 节点所使用的CustomTag, JspBody, NamedAttribute. 信息设置在收集器中.
     */
    public static class ChildInfo {
		private boolean scriptless;	// true 如果标签及其主体不包含脚本元素.
    ...
    public static class JspAttribute {
        ...
        /**
         * 如果JspAttribute表示一个命名属性. 在这种情况下, 必须存储属性的主体节点.
         */
    ...
    public static class Nodes {
		...
		private List list;
		private Node.Root root;		// null 如果不是一个页面
