...
/**
 * 格式化日期缓存最近日期信息，并使用它来避免过于频繁的调用底层格式化程序.
 * Note: breaks fieldPosition param of format(Date,
 * StringBuffer, FieldPosition).  如果你关心字段的位置, 直接调用底层的 DateFormat.
 */
public class FastDateFormat extends DateFormat {
     ...
     * Also: 在SimpleDateFormat中使用"S" 和 "SS"有一个bug, 如果想获得毫秒使用"SSS".
     */
