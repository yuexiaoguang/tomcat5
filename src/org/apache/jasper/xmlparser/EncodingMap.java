...
/**
 * EncodingMap 是一个方便的类处理IANA编码名称和java编码名称之间的转换, 反之亦然.
 * 在XML实例文档中的编码名称必须是指定IANA编码名称或IANA定义的别名之一.
 * <p>
 * <TABLE BORDER="0" WIDTH="100%">
 *  <TR>
 *      <TD WIDTH="33%">
 *          <P ALIGN="CENTER"><B>普通名称</B>
 *      </TD>
 *      <TD WIDTH="15%">
 *          <P ALIGN="CENTER"><B>在XML 文件中使用的名称</B>
 *      </TD>
 *      <TD WIDTH="12%">
 *          <P ALIGN="CENTER"><B>名称类型</B>
 *      </TD>
 *      <TD WIDTH="31%">
 *          <P ALIGN="CENTER"><B>Xerces 转换为这个Java Encoder 名称</B>
 *      </TD>
 *  </TR>
 *  <TR>
...
public class EncodingMap {
    ...
    /**
     * 添加一个IANA 到Java 编码名称映射.
     * 
     * @param ianaEncoding IANA 编码名称.
